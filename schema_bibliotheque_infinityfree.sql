...
SELECT 'Admin Biblio', 'admin@gestionbiblio.tg', '$2y$10$DZXBUaHLXvjIY3HAouwtVuQDhw6GCCIiTRirtQJDO.nhKXLyKDMge', r.id
...
FROM utilisateurs u WHERE u.email = 'admin@gestionbiblio.tg';
